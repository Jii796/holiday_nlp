...
public interface IClassifier
{
     ...
     * @throws IllegalStateException
     */
    int[] label(Document document,boolean flag) throws IllegalArgumentException,IllegalStateException;
    /**
     * 预测最可能的分类
     * @param text 文本
     * @return 最可能的分类
     ...
     *
     * @param text 文本
     * @param len  想要显示的标签的个数
     * @param flag 是否想要自动判别标签个数
     * @return 最可能的几个分类
     * @throws IllegalArgumentException
     * @throws IllegalStateException
     */
    String[] classify(String text, int len,boolean flag) throws IllegalArgumentException, IllegalStateException;
    /**
     * 预测最可能的分类
