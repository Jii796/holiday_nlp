...
public class DemoBasicTokenizer
{
    public static void main(String[] args)
    {
        ...
        System.out.println(BasicTokenizer.segment(text));//基本分词
        System.out.println(StandardTokenizer.segment(text));//标准分词
        System.out.println(NLPTokenizer.segment(text));//NLP分词
        System.out.println(IndexTokenizer.segment(text));//索引分词
        System.out.println(SpeedTokenizer.segment(text));//极速词典分词
